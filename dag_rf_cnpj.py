    ...
    try:
        ...
        insert_data_statement = """
            ...
            select cnpj,
                ...
                TO_DATE(to_number(data_situacao_cadastral), 'YYYYMMDD') as data_situacao_cadastral,
                TO_DATE(to_number(data_inicio_atividade), 'YYYYMMDD') as data_inicio_atividade,
                cnae,
                nome_cnae_principal,
