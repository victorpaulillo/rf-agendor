    ...
    try:
        ...
        insert_data_statement = """
            ...
            select cnpj,
                matriz_filial,
                nome_fantasia,
                TO_DATE(desc_situacao_cadastral, 'YYYYMMDD') as desc_situacao_cadastral,
                TO_DATE(data_situacao_cadastral, 'YYYYMMDD') as data_situacao_cadastral,
                TO_DATE(data_inicio_atividade, 'YYYYMMDD') as data_inicio_atividade,
                cnae,
                nome_cnae_principal,
